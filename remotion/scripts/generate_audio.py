...
def generate_ambient_bgm(output_path: str, duration_sec: float = 90.0, sample_rate: int = 44100):
...
if __name__ == "__main__":
    generate_ambient_bgm("/Users/takurot/src/agentic-film-ops/remotion/public/audio/bgm.wav", 90.0)
